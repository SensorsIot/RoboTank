...
class Joystick {
  ...
  **************************************************/
  ...
  const int minPositionValue = -512;                 // Note We want full pres
  const int maxPositionValue = 512;
  ...
  ****************************************************************************************************/
  public:
  Joystick(int tempXPin, long tempYPin)   {
    xPin = tempXPin;
    yPin = tempYPin;
  }
  ...
  ****************************************************************************************************/
  void readJoyStick() {
    int xRead = analogRead(yPin);
    int yRead = analogRead(xPin);
